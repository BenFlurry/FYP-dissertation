...
By recording 30 seconds of the doctor's voice, passing this into the \texttt{ECAPA-TDNN} model, and extracting the embedding, we can save this on device for all future use.
