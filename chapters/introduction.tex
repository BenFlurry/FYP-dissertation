...
Development began once technical this feasibility study concluded. Weekly meetings with my external supervisor and regular discussion with my internal supervisor and the NHS clients expanded the small starting feature pool. The initial requirements were loose, only needing the summarisation on device. Through demonstrations and feedback collection, these were expanded to include AVT, medical guidance and appraisal entries. The video demonstrations further verified alignment on the implementation of new requirements and promoted the project to potential clients including Dell, HP, Intel and the NHS. 
