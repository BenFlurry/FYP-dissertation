...
This chapter elaborates on the problem introduced previously, derives a structured set of requirements, and analyses those requirements to inform the first-pass design of the application. Requirements were initially set during the introductory meeting with my external supervisor, then modified and appended iteratively through meetings with both supervisors and demonstrations to NHS clinicians throughout the project.
